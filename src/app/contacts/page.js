...
import { isUserAuthenticated, getAllContactsByUser } from "@/../server/actions";
            ...
            <div className="sm:flex sm:items-center sm:justify-between">
                <div>
                    <div className="flex items-center gap-x-3">
                        ...
                        <span className="px-3 py-1 text-xs text-blue-600 bg-blue-100 rounded-full">240 contacts</span>
                    </div>
